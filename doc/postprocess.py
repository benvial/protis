...
def process_html(fn, lines):
    ...
    for line in lines:
        ...
        line = line.replace(
            "mybinder.org/v2/gh/protis/protis",
            "mybinder.org/v2/gl/protis%2Fprotis",
        )

        line = line.replace(
            "mybinder.org/v2/gl/protis%2Fprotis/doc?filepath=notebooks/examples/",
            "mybinder.org/v2/gl/protis%2Fprotis/doc?filepath=notebooks/",
        )
        ...
        new_binder_badge = "https://img.shields.io/badge/run-online-b04a65.svg?style=for-the-badge&labelColor=35253d&logo=data:image/png;base64,"
        line = line.replace(
...
def process_tex(lines):
    ...
    return [
        line
        for line in lines
        if not line.startswith(r"\section{protis.")
        and not line.startswith(r"\subsection{protis.")
        and not line.startswith(r"\subsubsection{protis.")
        and not line.startswith(r"\paragraph{protis.")
        and not line.startswith(r"\subparagraph{protis.")
    ]
