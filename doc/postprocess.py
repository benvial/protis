...
def process_tex(lines):
    ...
    for line in lines:
        if (
            line.startswith(r"\section{protis.")
            or line.startswith(r"\subsection{protis.")
            or line.startswith(r"\subsubsection{protis.")
            or line.startswith(r"\paragraph{protis.")
            or line.startswith(r"\subparagraph{protis.")
        ):
            pass  # skip!
        else:
            new_lines.append(line)
